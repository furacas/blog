...
然后就会自动进行破解了
![](images/FrQbX3SuAd6b2VH1Y-u_dp3mbVxx.png)
这里可以看出来能否破解的主要因素就是密码表是强大了。

这里我准备了 3.95G 的常用 wifi 密码字典。可以关注公众号**全栈编程笔记**回复**破解字典**进行下载
![](images/FpQVCvmbjMVdSCgMEXiTavBJFbet.png)

### 选择 WPS 是 yes 的

这种脚本会尝试破解 PIN

## ![](images/Fi1yGZ2-Ndh4Bzjt-5F0kiYw1Kfi.png)
